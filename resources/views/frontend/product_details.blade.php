            ...
            <div class="bg-white shadow-sm rounded p-3">
                <div class="row">
                    <div class="col-xl-5 col-lg-6 mb-4">
                        <div class="thumbnail-image-main">
                            <div class="carousel-box rounded">
                                <img
                                    class="img-fluid lazyload img-zoom"
                                    id="productThumbnaiImage"
                        ...
                        <div class="text-left">
                            ...
                            @else
                                @if(home_price($detailedProduct) != home_discounted_price($detailedProduct))
                                    ...
                                    <div class="row no-gutters my-2">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="">
                                                <strong class="h2 fw-600 gmg-text-orange">
                                ...
                                <div class="row no-gutters pb-3 d-none" id="chosen_price_div">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="product-price">
                                            <strong id="chosen_price" class="h4 fw-600 gmg-text-orange">
                            ...
                            <div class="mt-3">
                                ...
                                @else
                                    ...
                                    <button type="button" class="btn gmg-bg-orange text-white buy-now fw-600" onclick="buyNow()">
                            ...
                            <div class="d-table width-100 mt-3">
                                <div class="d-table-cell">
                                    ...
                                    <button type="button" class="btn pl-0 btn-link gmg-text-orange fw-600" onclick="addToWishList({{ $detailedProduct->id }})">
                                        {{ translate('Add to wishlist')}}
                                    </button>
                                    <!-- Add to compare button -->
                                    <button type="button" class="btn btn-link gmg-text-orange btn-icon-left fw-600" onclick="addToCompare({{ $detailedProduct->id }})">
                                ...
                                <li class="py-3 px-0 list-group-item border-light">
                                    <div class="row gutters-10 align-items-center">
                                        ...
                                        <div class="col-7 text-left">
                                            ...
                                            <div class="mt-2">
                                                <span class="fs-17 fw-600 gmg-text-orange">{{ home_discounted_base_price($top_product) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                                        ...
                                        <div class="p-md-3 p-2 text-left">
                                            <div class="fs-15">
                                                ...
                                                @endif
                                                <span class="fw-700 gmg-text-orange">{{ home_discounted_base_price($related_product) }}</span>
                                            </div>
                                            <div class="rating rating-sm mt-1">
