  ...
  <!-- footer / start -->
  <footer id="footer">
    <!-- floating small navigation menu -->
    {{-- <nav class="footer-navbar-sm fixed-bottom bg-white shadow d-md-none">
      <ul class="footer-navbar-nav d-flex align-items-center">
        <li class="nav-item">
          <button type="button" class="nav-link btn chat-toggler fs-3">
            <i class="fa-solid fa-comment-dots"></i>
          </button>
        </li>
        <li class="nav-item w-100 gmg-bg-orange">
          <a href="./cart.html" class="nav-link text-white text-capitalize fs-5" style="font-weight: 500">
            Place order
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link position-relative fs-3" data-bs-toggle="offcanvas" href="#sidebar-cart" role="button"
            aria-controls="sidebar-cart">
            <i class="fa-solid fa-cart-arrow-down"></i>
            <span class="position-absolute translate-middle badge rounded-pill gmg-bg-orange p-1"
              style="top: 0.5rem; left: 2.625rem; font-size: 0.75rem">
              99
    ...
    <div class="row align-items-center gutters-5">
        <div class="col">
            <a href="{{ route('home') }}" class="text-reset d-block text-center pb-2 pt-3">
                <i class="las la-home fs-20 opacity-60 {{ areActiveRoutes(['home'],'opacity-100 gmg-text-orange')}}"></i>
        ...
        <div class="col">
            <a href="{{ route('categories.all') }}" class="text-reset d-block text-center pb-2 pt-3">
                <i class="las la-list-ul fs-20 opacity-60 {{ areActiveRoutes(['categories.all'],'opacity-100 gmg-text-orange')}}"></i>
        ...
        <div class="col-auto">
            <a href="{{ route('cart') }}" class="text-reset d-block text-center pb-2 pt-3">
                <span class="align-items-center gmg-bg-orange border border-white border-width-4 d-flex justify-content-center position-relative rounded-circle size-50px" style="margin-top: -33px;box-shadow: 0px -5px 10px rgb(0 0 0 / 15%);border-color: #fff !important;">
        ...
        <div class="col">
            <a href="{{ route('all-notifications') }}" class="text-reset d-block text-center pb-2 pt-3">
                <span class="d-inline-block position-relative px-2">
                    <i class="las la-bell fs-20 opacity-60 {{ areActiveRoutes(['all-notifications'],'opacity-100 gmg-text-orange')}}"></i>
