            ...
            <div class="col-xl-8 mx-auto">
                <div class="row aiz-steps arrow-divider">
                    <div class="col active">
                        <div class="text-center gmg-text-orange">
                    ...
                    <div class="shadow-sm bg-white p-3 p-lg-4 rounded text-left">
                                    ...
                                    <li class="list-group-item px-0 px-lg-3">
                                        <div class="row gutters-5">
                                            ...
                                            <div class="col-lg col-4 order-3 order-lg-0 my-3 my-lg-0">
                                                ...
                                                <span class="fw-600 fs-16 gmg-text-orange">{{ single_price(($cartItem['price'] + $cartItem['tax']) * $cartItem['quantity']) }}</span>
                                            </div>
                                            <div class="col-lg-auto col-6 order-5 order-lg-0 text-right">
                                                <a href="javascript:void(0)" onclick="removeFromCartView(event, {{ $cartItem['id'] }})" class="btn btn-icon btn-sm btn-danger btn-circle">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6 text-center text-md-left order-1 order-md-0">
                                <a href="{{ route('home') }}" class="btn btn-link text-danger">
                            ...
                            <div class="col-md-6 text-center text-md-right">
                                @if(Auth::check())
                                    <a href="{{ route('checkout.shipping_info') }}" class="btn gmg-bg-orange fw-600 text-white">
                                        {{ translate('Continue to Shipping')}}
                                    </a>
                                @else
                                    <button class="btn gmg-bg-orange text-white fw-600" onclick="showCheckoutModal()">{{ translate('Continue to Shipping')}}</button>
                                @endif
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <form class="form-default" role="form" action="{{ route('cart.login.submit') }}" method="POST">
                            ...
                            <div class="mb-5">
                                <button type="submit" class="btn gmg-bg-orange text-white btn-block fw-600">{{  translate('Login') }}</button>
                            </div>
                        </form>
