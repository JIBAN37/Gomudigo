<div class="card border-0 shadow-sm rounded">
    ...
    <div class="card-body">
        @if (addon_is_activated('club_point'))
            ...
            <div class="rounded px-2 mb-2 bg-soft-danger border-soft-danger border">
                    ...
                    <form class="" action="{{ route('checkout.remove_club_point') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button type="submit" class="btn btn-danger">{{translate('Remove Redeem Point')}}</button>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="mt-3">
                        ...
                        <form class="" action="{{ route('checkout.apply_club_point') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button type="submit" class="btn btn-danger">{{translate('Redeem')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="mt-3">
                    <form class="" id="remove-coupon-form" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button type="button" id="coupon-remove" class="btn gmg-bg-orange text-white">{{translate('Change Coupon')}}</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="mt-3">
                    <form class="" id="apply-coupon-form" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button type="button" id="coupon-apply" class="btn gmg-bg-orange text-white">{{translate('Apply')}}</button>
                            </div>
                        </div>
                    </form>
                </div>
