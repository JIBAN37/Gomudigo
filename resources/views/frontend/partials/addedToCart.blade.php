<div class="modal-body p-4 added-to-cart">
    ...
    <div class="text-center">
        <button class="btn btn-outline-danger mb-3 mb-sm-0" data-dismiss="modal">{{ translate('Back to shopping')}}</button>
        <a href="{{ route('cart') }}" class="btn gmg-bg-orange text-white mb-3 mb-sm-0">{{ translate('Proceed to Checkout')}}</a>
    </div>
</div>
