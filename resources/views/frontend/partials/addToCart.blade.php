    ...
    <div class="row">
                        ...
                        @foreach ($product->stocks as $key => $stock)
                            @if ($stock->image != null)
                                <div class="carousel-box c-pointer border p-1 rounded" data-variation="{{ $stock->variant }}">
                                    <img
                                        class="lazyload mw-100 size-50px "
                                        src="{{ static_asset('assets/img/placeholder.jpg') }}"
                                        data-src="{{ uploaded_asset($stock->image) }}"
                                        onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';"
                                    >
        ...
        <div class="col-lg-6">
            <div class="text-left">
                ...
                <div class="mt-3">
                    @if ($product->digital == 1)
                        <button type="button" class="btn gmg-bg-orange text-white buy-now fw-600 add-to-cart" onclick="addToCart()">
                            <i class="la la-shopping-cart"></i>
                            <span class="d-none d-md-inline-block">{{ translate('Add to cart')}}</span>
                        </button>
                    @elseif($qty > 0)
                        @if ($product->external_link != null)
                            <a type="button" class="btn gmg-bg-orange text-white mr-2 add-to-cart fw-600" href="{{ $product->external_link }}">
                        ...
                        @endif
                    @endif
                    <button type="button" class="btn btn-danger out-of-stock fw-600 d-none" disabled>
