            ...
            <div class="col-xxl-8 col-xl-10 mx-auto">
                <form class="form-default" action="{{ route('checkout.store_delivery_info') }}" role="form" method="POST">
                    ...
                    <div class="card mb-3 shadow-sm border-0 rounded">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                <input class="from-group" type="date" name="">
                                <input class="from-group" type="time" name="">
                            </ul>
                    ...
                    <div class="pt-4 d-flex justify-content-between align-items-center">
                        ...
                        <button type="submit" class="btn fw-600 gmg-bg-orange text-white">{{ translate('Continue to Payment')}}</button>
                    </div>
                </form>
            </div>
        </div>
