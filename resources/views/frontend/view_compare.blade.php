                                ...
                                <tr>
                                    ...
                                    @foreach (Session::get('compare') as $key => $item)
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            <span class="fw-700 gmg-text-orange">{{ home_discounted_base_price($product) }}</span>
                                        </td>
                                    @endforeach
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    @foreach (Session::get('compare') as $key => $item)
                                        <td class="text-center py-4">
                                            <button type="button" class="btn gmg-bg-orange fw-600" onclick="showAddToCartModal({{ $item }})">
