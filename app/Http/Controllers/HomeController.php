...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $recent_products = Cache::rememberForever('recent_products', function () {
            return filter_products(Product::where('published', 1))->limit(18)->orderBy('id', 'desc')->get();            
        });

        return view('frontend.index', compact('featured_categories', 'todays_deal_products','featured_products','recent_products'));
    }
    ...
    public function dashboard()
    {
        ...
        elseif(Auth::user()->user_type == 'customer'){
            ...
            $last_five=OrderDetail::where('order_id',$order_id)->paginate(5);

          return view('frontend.user.customer.dashboard',compact('last_five'));
        }
...
//        $categories = Category::where('level', 0)->orderBy('name', 'asc')->get();
    ...
    public function aboutUs(){
        return view("frontend.policies.about-us");
    }
